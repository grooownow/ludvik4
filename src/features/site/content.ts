...
const ru: MarketContent = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Автоматизация одного бизнес-процесса",
        body: "Один повторяющийся ручной процесс переносим в контролируемый workflow: обработка заявок, извлечение данных из документов, подготовка контента на согласование, регулярные отчёты — на скриптах, интеграциях, ботах и AI",
      },
      {
        module: "Module / MVP",
        title: "MVP одного ключевого сценария",
        body: "Небольшое веб-приложение вокруг одной основной задачи и одного законченного пути пользователя. При необходимости — аккаунты, база, файлы, уведомления, AI или оплата",
      },
    ],
  },
  formats: [
  ...
  pricing: {
    ...
    rows: [
      ...
      { title: "Автоматизация одного бизнес-процесса", price: "от 10 000 ₽" },
      { title: "MVP / компактный SaaS", price: "от 50 000 ₽" },
    ],
  },
  faq: true,
  about: {
...
const en: MarketContent = {
  ...
  services: {
    ...
    items: [
      ...
      {
        module: "Module / Automation",
        title: "One business workflow automation",
        body: "One repetitive manual process moved into a controlled workflow: intake handling, document data extraction, content prepared for review, scheduled reports — with scripts, integrations, bots and AI.",
      },
      {
        module: "Module / MVP",
        title: "Focused MVP or compact SaaS",
        body: "A small web app around one core task and one complete user journey. When the scenario needs it: accounts, a database, files, notifications, AI or payments.",
      },
    ],
  },
  aiBlock: {
