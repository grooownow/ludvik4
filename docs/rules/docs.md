...
| `docs/archive/`                       | Completed one-time plans and prompts, kept for history — nothing current lives here (see its README)                                                                                                     |
| `src/content/blog/`                   | Blog articles (MDX) — editorial standards and publishing flow in `docs/rules/content.md`                                                                                                                 |
