...
- Сохранить EN lead form с доставкой только на email через Resend. Telegram
  оставить отдельной прямой ссылкой, не дублировать туда данные формы.
- Не расширять набор собираемых данных.
- Сохранить английские labels и сообщения.
- Privacy notice опубликована в `/privacy` и должна соответствовать фактическим
  провайдерам формы.
